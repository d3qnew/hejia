            ...
            afterEach(function () {
                if (!isWindowsStore) {
                    try {
                        ...
                        mycon.err('Error removing batterystatus event listener: ' + e);
                    }
                }
            });
            ...
            afterEach(function () {
                if (!isWindowsStore) {
                    try {
                        ...
                        mycon.err('Error removing batterylow event listener: ' + e);
                    }
                }
            });
            ...
            afterEach(function () {
                if (!isWindowsStore) {
                    try {
                        ...
                        mycon.err('Error removing batterycritical event listener: ' + e);
                    }
                }
            });
